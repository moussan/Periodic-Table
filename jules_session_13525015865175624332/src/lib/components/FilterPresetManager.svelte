...
{#if isOpen}
  <div class="preset-manager-overlay" role="button" tabindex="0" on:keydown={(e) => { if(e.key === 'Enter' || e.key === ' ') isOpen = false; }} on:click={() => isOpen = false}>
    <div class="preset-manager glass" role="dialog" on:click|stopPropagation>
